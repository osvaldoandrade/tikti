...
This worktree is based on the exact Go source embedded in the production Tikti image, commit `941a0d17f889f0f03901ace525f92e98949f3aac`. Keep the temporary-password change focused; the current upstream main has a different runtime and must not be substituted into the production wrapper without a separate migration.
