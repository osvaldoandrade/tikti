...
The canonical Identity V2 directory and explicit-tenant assignment routes are
always registered. Startup completes the bounded, idempotent Redis backfill
before serving traffic. `config.identityGroupsV1` remains false by default;
turning it off again blocks group mutations without removing groups, members,
direct assignments, or inherited-access data. Direct user assignments remain
available independently of the groups flag.
