...
func TestExactMembershipRoutesContract(t *testing.T) {
	...
	tests := []struct {
		...
		{"platform authority is not home allowlisted", "/v1/admin/tenants/outside/memberships", platform, "api-key-canary", "", 200, `"tenantId":"outside"`},
		...
		{"dynamic provenance-bound principal", "/v1/admin/tenants/new-tenant/memberships", dynamicForeign, "api-key-canary", "", 200, `"tenantId":"new-tenant"`},
