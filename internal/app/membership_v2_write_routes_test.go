...
func TestMembershipV2WriteRouteContract(t *testing.T) {
	...
	tests := []struct {
		...
		{"platform authority is not home allowlisted", "/v1/admin/tenants/outside/memberships/user-1", platform, "api-key", validBody, "application/json", 201, 1},
		{"dynamic target", "/v1/admin/tenants/new-tenant/memberships/user-1", dynamicPlatform, "api-key", validBody, "application/json", 201, 1},
		{"dynamic provenance-bound principal", "/v1/admin/tenants/new-tenant/memberships/user-1", dynamicForeign, "api-key", validBody, "application/json", 201, 1},
