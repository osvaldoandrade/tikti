> Canonical source: [`docs/08_migration_and_implementation_plan.md`](https://github.com/osvaldoandrade/tikti/blob/main/docs/08_migration_and_implementation_plan.md)
